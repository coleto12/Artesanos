...
export default function Checkout() {
  ...
  const handlePay = async () => {
    ...
    try {
      const sigRes = await api.post('/signature/', { reference, amount: String(totalCentavos), currency: 'COP' })
  ...
  return (
    <div style={{ ...s.page, padding: isMobile ? '24px 16px 48px' : '40px 56px 64px', colorScheme: 'light' }}>
      ...
      <h1 style={{ ...s.title, fontSize: isMobile ? '1.6rem' : '2rem' }}>Información de envío</h1>
      <div style={s.titleBar} />

      <div style={{ ...s.layout, gridTemplateColumns: isMobile ? '1fr' : '1fr 380px', gap: isMobile ? '32px' : '48px' }}>
        ...
        <div style={{ ...s.summary, position: isMobile ? 'static' : 'sticky' }}>
          ...
          <button style={s.payBtn} onClick={handlePay}>Realizar pago →</button>
...
const s = {
  ...
  title: { fontFamily: "'Playfair Display', serif", fontWeight: 700, margin: '0 0 10px', color: '#1a1a1a' },
  titleBar: { width: '48px', height: '3px', background: GOLD, marginBottom: '32px' },
  layout: { display: 'grid', alignItems: 'start' },
  formSection: {},
  formSectionTitle: { fontFamily: "'Playfair Display', serif", fontSize: '1.1rem', fontWeight: 700, margin: '0 0 20px', color: '#1a1a1a' },
  ...
  input: { padding: '11px 14px', borderRadius: '6px', border: '1px solid #ddd', fontSize: '0.95rem', fontFamily: 'inherit', outline: 'none', background: '#fff', color: '#222' },
  ...
  summaryTitle: { fontFamily: "'Playfair Display', serif", fontSize: '1.2rem', fontWeight: 700, margin: '0 0 10px', color: '#1a1a1a' },
  ...
  summaryItemImg: { width: '44px', height: '44px', borderRadius: '6px', overflow: 'hidden', background: '#fff', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  payBtn: { width: '100%', padding: '14px', background: BEIGE, color: '#fff', border: 'none', borderRadius: '8px', fontSize: '1rem', cursor: 'pointer', fontWeight: 600, marginBottom: '16px' },
  wompiInfo: { textAlign: 'center', marginBottom: '16px' },
  wompiText: { fontSize: '0.75rem', color: '#aaa', margin: '0 0 6px' },
  wompiBadge: { display: 'inline-block', background: '#7B2D8B', color: '#fff', padding: '4px 14px', borderRadius: '4px', fontSize: '0.85rem', fontWeight: 700, marginBottom: '6px' },
  wompiMethods: { fontSize: '0.72rem', color: '#aaa', margin: 0 },
  backLink: { display: 'block', textAlign: 'center', fontSize: '0.85rem', color: '#888', textDecoration: 'none' },
